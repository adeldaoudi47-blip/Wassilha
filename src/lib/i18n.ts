...
export const translations = {
  ar: {
    ...
    saveStoreInfo: 'حفظ',
    // === HIRFA Phase 3: variants / tiers / Q&A / coupons / photo reviews =====
    // Variants (Alibaba-style SKUs: size, colour, material).
    variant: 'الخيار',
    chooseVariant: 'اختر الخيار',
    variantOutOfStock: 'هذا الخيار غير متوفر',
    selectVariantFirst: 'اختر الخيار أولاً',
    // Graduated (wholesale) pricing tiers.
    startingFrom: 'ابتداءً من',
    perUnit: 'للوحدة',
    wholesalePricing: 'أسعار الجملة',
    tierMinQuantity: 'الكمية',
    tierUnitPrice: 'سعر الوحدة',
    tierReached: 'تم تفعيل سعر الجملة',
    tierHint: 'كلما زادت الكمية، انخفض سعر الوحدة',
    // Product video.
    productVideo: 'فيديو المنتج',
    videoUrl: 'رابط الفيديو (اختياري)',
    videoUrlHint: 'رابط YouTube أو Vercel Blob للفيديو',
    // Q&A (buyer asks, artisan answers).
    questionsAndAnswers: 'الأسئلة والأجوبة',
    askQuestion: 'اطرح سؤالاً',
    questionPlaceholder: 'اكتب سؤالك عن هذا المنتج…',
    questionSent: 'تم إرسال سؤالك',
    answerQuestion: 'أجب',
    answerPlaceholder: 'اكتب إجابتك…',
    answerSent: 'تمت الإجابة',
    noQuestionsYet: 'لا توجد أسئلة بعد. كن أول من يسأل!',
    answeredBadge: 'تمت الإجابة',
    pendingBadge: 'في انتظار الرد',
    // Photo reviews + "helpful" votes + the artisan's reply.
    reviewPhotos: 'الصور المرفقة',
    attachReviewPhotos: 'أرفق صور المنتج (اختياري)',
    helpful: 'مفيد',
    markHelpful: 'السؤال/التقييم مفيد',
    ...
    // Coupons (artisan-owned discount codes).
    ...
    switchToCustomer: 'التبديل إلى وضع الزبون',
    switchToDriver: 'العودة إلى وضع السائق',
                    switchToArtisan: 'العودة إلى وضع الحرفي',
    customerViewMode: 'أنت في وضع الزبون',
  ...
  fr: {
    ...
    madeToOrderHint: 'Fabriqué sur commande, quantité illimitée',
    isMadeToOrderLabel: 'Ce produit est sur commande',
    ...
    // === HIRFA Phase 3 : variantes / paliers / Q&R / coupons / avis photos ===
    // Variantes (déclinaisons type Alibaba : taille, couleur, matière).
    variant: 'Variante',
    chooseVariant: 'Choisir une variante',
    variantOutOfStock: 'Cette variante est en rupture',
    selectVariantFirst: 'Choisissez d’abord une variante',
    // Tarifs dégressifs (gros).
    startingFrom: 'À partir de',
    perUnit: 'l’unité',
    wholesalePricing: 'Tarifs de gros',
    tierMinQuantity: 'Quantité',
    tierUnitPrice: 'Prix unitaire',
    tierReached: 'Prix de gros appliqué',
    tierHint: 'Plus la quantité est élevée, plus le prix unitaire baisse',
    // Vidéo du produit.
    productVideo: 'Vidéo du produit',
    videoUrl: 'Lien vidéo (optionnel)',
    videoUrlHint: 'Lien YouTube ou Vercel Blob de la vidéo',
    // Q&R (l’acheteur pose une question, l’artisan répond).
    questionsAndAnswers: 'Questions & réponses',
    askQuestion: 'Poser une question',
    questionPlaceholder: 'Écrivez votre question sur ce produit…',
    questionSent: 'Votre question a été envoyée',
    answerQuestion: 'Répondre',
    answerPlaceholder: 'Écrivez votre réponse…',
    answerSent: 'Réponse envoyée',
    noQuestionsYet: 'Aucune question pour l’instant. Soyez le premier à demander !',
    answeredBadge: 'Répondu',
    pendingBadge: 'En attente de réponse',
    // Avis photos + votes « utile » + réponse de l’artisan.
    reviewPhotos: 'Photos jointes',
    attachReviewPhotos: 'Joindre des photos du produit (optionnel)',
    helpful: 'Utile',
    markHelpful: 'Cet avis est utile',
    sellerReply: 'Réponse du vendeur',
    replyToReview: 'Répondre à cet avis',
    replyPlaceholder: 'Écrivez votre réponse à cet avis…',
    replySent: 'Réponse envoyée',
    replyEmpty: 'Écrivez d’abord une réponse',
    // Coupons (codes de réduction créés par l’artisan).
    coupons: 'Codes de réduction',
    couponCode: 'Code de réduction',
    couponPlaceholder: 'Saisissez le code de réduction',
    applyCoupon: 'Appliquer',
    removeCoupon: 'Retirer',
    couponApplied: 'Code appliqué',
    discount: 'Réduction',
    totalAfterDiscount: 'Total après réduction',
    invalidCoupon: 'Code de réduction invalide',
    couponNotFound: 'Ce code n’existe pas',
    couponExpired: 'Ce code a expiré',
    couponExhausted: 'Ce code est épuisé',
    couponMinOrder: 'Montant minimum',
    couponScopeHint: 'Le code ne s’applique qu’à une seule boutique du panier',
    manageCoupons: 'Gérer les codes',
    createCoupon: 'Créer un code',
    couponType: 'Type de réduction',
    couponPercent: 'Pourcentage %',
    couponFixed: 'Montant fixe',
    couponValue: 'Valeur de la réduction',
    minOrderAmount: 'Montant minimum de commande (optionnel)',
    usageLimit: 'Limite d’utilisation (optionnel)',
    expiresAt: 'Date d’expiration (optionnel)',
    couponActive: 'Actif',
    couponInactive: 'Suspendu',
    noCoupons: 'Aucun code pour l’instant',
    usedCount: 'Utilisations',
    couponCreated: 'Code créé',
    couponDeleted: 'Code supprimé',
    deleteCouponConfirm: 'Supprimer définitivement ce code ?',
    codeUppercaseHint: 'Le code est enregistré en majuscules (WELCOME10 = welcome10)',
    dir: 'ltr' as const,
    appName: 'WASSILHA',
    appSub: 'وَصِّلها',
    ...
    switchToDriver: 'Retour au mode chauffeur',
                    switchToArtisan: 'Retour au mode artisan',
    customerViewMode: 'Vous êtes en mode client',
